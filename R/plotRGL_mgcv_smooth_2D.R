...
#' @export
#'
plotRGL.mgcv.smooth.2D <- function(
  x,
  se = TRUE,
  n = 40,
  residuals = FALSE,
  ...
  if (type == "auto") {
    type <- .getResTypeAndMethod(x$gObj$family)$type
  }
